...
public class Docente extends Professor {
    public Docente(String data_ingresso, String nr_identificacao, String nome, String apelido, int ano_nascimento, String genero, String estado_civil, String nacionalidade, String endereco, String nr_bi, int telefone, String email, String especialidade, String grau_academico, String instituicao, String cargo, double carga_horaria, double salario_hora, boolean trabalho_extra, double hora_extra, double valor_hora_extra, double deducao, int nuit, int inss, String outras_observacoes) {
